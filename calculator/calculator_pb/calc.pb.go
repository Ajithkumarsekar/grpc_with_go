...
func (x *FindMaximumRequest) Reset() {
	*x = FindMaximumRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_calculator_calculator_pb_calc_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FindMaximumRequest) Descriptor() ([]byte, []int) {
	return file_calculator_calculator_pb_calc_proto_rawDescGZIP(), []int{7}
}
...
func (x *FindMaximumResponse) Reset() {
	*x = FindMaximumResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_calculator_calculator_pb_calc_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FindMaximumResponse) Descriptor() ([]byte, []int) {
	return file_calculator_calculator_pb_calc_proto_rawDescGZIP(), []int{8}
}

func (x *FindMaximumResponse) GetMaxNum() int64 {
	if x != nil {
		return x.MaxNum
	}
	return 0
...
var file_calculator_calculator_pb_calc_proto_rawDesc = []byte{
	...
	,
	...
	0x62, 0x0a, 0x11, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x54, 0x6f, 0x50, 0x72,
	0x69, 0x6d, 0x65, 0x73, 0x12, 0x22, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f,
	0x72, 0x2e, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x25, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75,
	0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x64,
	...
	0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x1c, 0x5a, 0x1a, 0x2e, 0x2f, 0x63, 0x61, 0x6c, 0x63,
...
var file_calculator_calculator_pb_calc_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
var file_calculator_calculator_pb_calc_proto_depIdxs = []int32{
	...
	2, // 5: calculator.CalculatorService.SumNums:output_type -> calculator.SumResponse
	4, // 6: calculator.CalculatorService.DecomposeToPrimes:output_type -> calculator.DecomposedNumbersResponse
...
func file_calculator_calculator_pb_calc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_calculator_pb_calc_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_calculator_calculator_pb_calc_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
